...
$detalle.="
         <table border=\".1\">
            <tr>
           <td colspan=\"12\" align=\"center\"><strong>PREMIOS DE $mesx DEL $aaa</strong></td>
           </tr>
           <tr>
           <td colspan=\"12\" align=\"center\">SUCURSAL..:<strong>".$suc." DEL ".$sucx."</strong> <br /></td>
           </tr>
 
        <tr>
        <th colspan=\"9\" align=\"right\"><strong></strong></th>
         <th colspan=\"3\" align=\"center\"><strong>EN DIAS</strong></th>
        </tr>

        <tr>
        <th align=\"center\" colspan=\"3\"><strong>PUESTO</strong></th>
        <th align=\"center\"  colspan=\"6\"><strong>EMPLEADO</strong></th>
        <th align=\"center\"><strong>VENTA</strong></th>
        <th align=\"center\"><strong>INCREMENTO</strong></th>
...
$detalle.="
         <tr>
            <td align=\"left\" colspan=\"3\"><font color=\"black\">".$r1->puesto."</font></td>
            <td align=\"left\" colspan=\"6\"><font color=\"black\">".str_pad($r1->nomina,6,"0",STR_PAD_LEFT)." - ".trim($r1->pat)." ".trim($r1->mat)." ".trim($r1->nom)."</font></td>
            <td align=\"center\"><font color=\"blue\"><strong>".$r1->vta_dias."</strong></font></td>
            <td align=\"center\"><font color=\"blue\"><strong>".$r1->incre_dias."</strong></font></td>
            <td align=\"center\"><font color=\"blue\"><strong>".($r1->vta_dias+$r1->incre_dias)."</strong></font></td>
        </tr> ";  
        }
