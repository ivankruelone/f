...
<div align="center">
  <?php
	$atributos = array('id' => 'nacional_form_pedidos_ger_for_nid');
    echo form_open('nacional/tabla_desplaza_t_nid', $atributos);
  ?>
...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
    $('#nacional_form_pedidos_ger_for_nid').submit(function() {
