...
<div align="center">
  <?php
	$atributos = array('id' => 'cat_generico_form_cambia');
    echo form_open('cat_generico/cambio_producto', $atributos);
...
<tr>
	<td align="left" ><font size="+1">CLAVE GOB: </font></td>
...
/////////////////////////////////////////////////
    ...
    $('#cat_generico_form_cambia').submit(function() {
