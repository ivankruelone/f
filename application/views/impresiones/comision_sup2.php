...
$num=1;
$s0 = "select a.*, sum(sup_nat)as premio_nat  from vtadc.comision a
where
fecha='$fecha' and puestox='SUP' and sup_nat>0
group by  nomina";
$q0 = $this->db->query($s0);
...
//----------------------------------------------------------------------------------------------------------------
 ...
 where a.nomina=$r0->nomina  and fecha='$fecha' and sup_nat>0";
        $q2 = $this->db->query($s2);
...
$detalle.="
         ...
         <tr>
            ...
            <td align=\"right\" colspan=\"1\"><strong> $ ".number_format($r2->sup_nat,2)."</strong></td>
        </tr> ";  
$num=$num+1;
        }           
$detalle.=" 
        <tr bgcolor=\"#EDD8D8\">
           <td colspan=\"3\" align=\"center\">SUPERVISOR..:<strong>".$r0->nomina." - ".$r0->pat." ".$r0->mat." ".$r0->nom."</strong> <br /></td>
