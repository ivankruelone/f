...
<div align="center">
  <?php
	$atributos = array('id' => 'direccion_form_ventas');
    echo form_open('direccion/tabla_control_ventas', $atributos);
  ?>
...
<tr>
	...
	<td align="left"><?php echo form_dropdown('far', $far, '', 'id="far"') ;?> </td>
 </tr>
...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
    $('#direccion_form_ventas').submit(function() {
