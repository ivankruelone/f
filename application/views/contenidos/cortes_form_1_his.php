...
<div align="center">
  <?php
	$atributos = array('id' => 'cortes_form_1_his');
    echo form_open('cortes/actualiza_d', $atributos);
     $data_1 = array(
              'name'        => 'l1',
              'id'          => 'l1',
              'value'       => $venta1,
...
<table>
<tr>
<th colspan="4"><font size="+1"><?php echo $sucursal ."_";?> FECHA.:<?php echo $fechac;?><?php echo "<br /> VENTA GLOBAL ". $vta ?></font></th>
</tr>
<tr>
    <th>LINEA</th>
	<th>VENTA</th>
...
<tr>
   ...
   <th align="center" colspan="2"><font size="-1" color="red">TOT.CORTE <?php echo $vta?></font></th>
   <th align="center" colspan="2"><font size="-1" color="red">TOT.LINEA <span id="suma0"></span></font></th>
</tr>
<tr>
   ...
   function suma1()
     {
        ...
        var l30=parseFloat($("#l30").attr('value'));
        var l40=parseFloat($("#l40").attr('value'));
        ...
        var lc30=parseFloat($("#lc30").attr('value'));
        var lc40=parseFloat($("#lc40").attr('value'));
        ...
        var la30=parseFloat($("#la30").attr('value'));
        var la40=parseFloat($("#la40").attr('value'));
        ...
        if(isNaN(lc30)){lc30=0;}
        if(isNaN(lc40)){lc40=0;}
        ...
        if(isNaN(la30)){la30=0;}
        if(isNaN(la40)){la40=0;}
       ...
       var suma0 = l1+l2+l4+l5+l8+l9+l10+l11+l12+l13+l16+l19+l20+l21+l22+l23+l24+l30+l40+
       ...
       var corte  = parseFloat(turno1_corte) + parseFloat(turno2_corte) +  parseFloat(turno3_corte) + parseFloat(turno4_corte);
        ...
        suma1x=Math.round(suma1x*100)/100  //returns 28.45
       ...
       $("#turno4_corte").val(turno4_corte);
        ...
        var vta = $('#vta').attr("value")+la20-lc20;
        $("#vta").html(vta);

        
        var l20 = $('#l20').attr("value");
        $("#l20").html(l20);
         var la20 = $('#la20').attr("value");
        $("#la20").html(la20);
         var lc20 = $('#lc20').attr("value");
        $("#lc20").html(lc20);
     }
   ///**************************************************  
////////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////
    $('#cortes_form_1_his').submit(function() {
        la20=parseFloat($("#la20").html());
        lc20=parseFloat($("#lc20").html());
        l20=parseFloat($("#l20").html());
		...
		telcel = $('#telcel').attr("value");
        var telcel = parseFloat(l20)-parseFloat(lc20)-parseFloat(recarga);
        if(isNaN(telcel)){telcel=0;}
