...
<div align="center">
  <?php
	$atributos = array('id' => 'credito_form_2');
    echo form_open('cortes/agrega_credito_cor', $atributos);
      $data_importe = array(
              'name'        => 'importe',
              'id'          => 'importe',
              'value'       => '',
...
<tr>
 ...
 <tr>
	<td align="left" ><font size="+1"><strong>Folio de notas: </strong></font></td>
...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
    $('#credito_form_2').submit(function() {
