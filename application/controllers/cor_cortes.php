...
class Cor_cortes extends CI_Controller
{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    {
        $data['mensaje']= '';
        $data['titulo']= 'BUEN DIA AL PERSONAL DE CORTES';
        $data['titulo1']= '';
        $data['tabla']= 'BUENOS DIAS A TODO EL PERSONAL';
        $data['contenido']= "cor_cortes";
        $data['selector'] = "cor_cortes";
        $data['sidebar'] = "sidebar_cor_cortes";
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    
  public function subir_cortes()
    {
        $data['titulo'] = "CORTES";
        $data['contenido'] = "subir_cor_cortes";
         $data['selector'] = "cor_cortes";
        $data['sidebar'] = "sidebar_cor_cortes";
        $data_c['extraheader'] = "
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function upload()
    {
        ...
        $this->load->model('cor_cortes_model');
        echo $this->cor_cortes_model->inserta_archivos($file, $var['size'], $string);
  ...
  public function tabla_control()
    {
        ...
        $data['tabla'] = $this->cor_cortes_model->control();
        $data['titulo'] = "CORTES";
        $data['titulo1']= '';
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  public function tabla_detalle_prceso1($id_cc)
    {
         $this->load->model('catalogo_model');
		
        $this->load->model('cor_cortes_model');
        $data['tabla'] =$this->cor_cortes_model->edita_detalle($fecha,$suc);
        $data['titulo1'] = "";
 ...
 function actualiza_impo()
    {
        $data = array('impo' => $this->input->post('valor'));
        $this->db->where('id', $this->input->post('id'));
        $this->db->update('corte_b', $data);
    }
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 public function tabla_detalle_prceso2($fecha,$suc)
    {
       $this->load->model('cortes_model');
		$query =$this->cortes_model->busca_suc($suc);
        $row=$query->row();
        $iva=$row->iva;
        $suc=$row->suc;
        $sucx=$row->nombre;
...
public function graba(){
        ...
        $efectivo1  =$this->input->post('efectivo1');
        $dolar1  =$this->input->post('dolar1');
        $cambio1 =$this->input->post('cambio1');
        $bbv1    =$this->input->post('bbv1');
        $san1    =$this->input->post('san1');
        $exp1    =$this->input->post('exp1');
        $asalto1 =$this->input->post('asalto1');
        $vale1   =$this->input->post('vale1');
        $cajera1 =$this->input->post('cajera1');
        $corte1  =$this->input->post('corte1');
        
        $efectivo2=$this->input->post('efectivo2');
        $dolar2  =$this->input->post('dolar2');
        $cambio2 =$this->input->post('cambio2');
        $bbv2    =$this->input->post('bbv2');
        $san2    =$this->input->post('san2');
        $exp2    =$this->input->post('exp2');
        $asalto2 =$this->input->post('asalto2');
        $vale2   =$this->input->post('vale2');
        $cajera2 =$this->input->post('cajera2');
        $corte2  =$this->input->post('corte2');
        
        $efectivo3=$this->input->post('efectivo3');
        $dolar3  =$this->input->post('dolar3');
        $cambio3 =$this->input->post('cambio3');
        $bbv3    =$this->input->post('bbv3');
        $san3    =$this->input->post('san3');
        $exp3    =$this->input->post('exp3');
        $asalto3 =$this->input->post('asalto3');
        $vale3   =$this->input->post('vale3');
        $cajera3 =$this->input->post('cajera3');
        $corte3  =$this->input->post('corte3');
        
        $efectivo4  =$this->input->post('efectivo4');
        $dolar4  =$this->input->post('dolar4');
        $cambio4 =$this->input->post('cambio4');
        $bbv4    =$this->input->post('bbv4');
        $san4    =$this->input->post('san4');
        $exp4   =$this->input->post('exp4');
        $asalto4 =$this->input->post('asalto4');
        $vale4   =$this->input->post('vale4');
        $cajera4 =$this->input->post('cajera4');
        $corte4  =$this->input->post('corte4');

$arqueo1=$efectivo1+$bbv1+$san1+$exp1+$asalto1+$vale1+($dolar1*$cambio1);
$arqueo2=$efectivo2+$bbv2+$san2+$exp2+$asalto2+$vale2+($dolar2*$cambio2);
$arqueo3=$efectivo3+$bbv3+$san3+$exp3+$asalto3+$vale3+($dolar3*$cambio3);
$arqueo4=$efectivo4+$bbv4+$san4+$exp4+$asalto4+$vale4+($dolar4*$cambio4);

if($arqueo1>$corte1){$sob1=$arqueo1-$corte; $fal1=0;}else{$fal1=$corte-$arqueo1; $sob1=0;}
if($arqueo2>$corte2){$sob2=$arqueo2-$corte; $fal2=0;}else{$fal2=$corte-$arqueo2; $sob2=0;}
if($arqueo3>$corte3){$sob3=$arqueo3-$corte; $fal3=0;}else{$fal3=$corte-$arqueo3; $sob3=0;}
if($arqueo4>$corte4){$sob4=$arqueo4-$corte; $fal4=0;}else{$fal4=$corte-$arqueo4; $sob4=0;}
...
echo $arqueo1x."-".$corte1."__".$arqueo2x."-".$corte2."__".$l20."-".$recarga;
if($arqueo1x==$corte1 && $arqueo2x==$corte2 && $arqueo3x==$corte3 && $arqueo4x==$corte4 && 
$l20>=$recarga){        


$this->load->model('cor_cortes_model');
$this->cor_cortes_model->create_member($valor_iva,$suc,$fecha,$l1,$l2,$l4,$l5,$l8,$l9,$l10,$l11,$l12,$l13,$l16,$l19,$l20,$l21,$l22,$l23,$l24,$l30,$l40,
...
redirect('cor_cortes/tabla_control');
}else{
$mensaje=3;    
redirect('cor_cortes/portada/'.$mensaje);   
}
...
public function cambia_fal($id)
    {
        ...
        $data['tabla'] = $this->cortes_model->control_fal_t_con($id,$clave);
        $data['id_fal'] = $id;
