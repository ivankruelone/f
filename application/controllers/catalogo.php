   ...
   public function tabla_cedis()
    {
        ...
        $data['tabla'] = $this->catalogo_model->cedis();
   ...
   public function catalogo_usuarios()
    {
        ...
        $data['contenido'] = "catalogo_form_usuario_0";
        $data['selector'] = "catalogo";
        $data['sidebar'] = "sidebar_catalogo";
...
function agrega_c_usuario()
	...
	$this->load->model('catalogo_model');
    $this->catalogo_model->agrega_member_usuario($usuario,$nombre,$puesto,$email,$activo,$pas,$suc,$id);
