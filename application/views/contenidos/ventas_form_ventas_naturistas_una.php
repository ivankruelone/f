...
<div align="center">
  <?php
	$atributos = array('id' => 'ventas_form_ventas_naturistas_una');
    echo form_open('ventas/graba_control_ventas_naturistas_una', $atributos);
  $data_suc = array(
              'name'        => 'suc',
              'id'          => 'suc',
              'value'       => '',
...
<tr>
	...
	<td align="left"><?php echo form_input($data_suc, "",'required');?> </td>
 </tr>
  <tr>
...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
    $('#ventas_form_ventas_naturistas_una').submit(function() {
