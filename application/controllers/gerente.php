...
/////////////////////////////////////////////////////////////////////////////////////////////lidia
    ...
    public function index()
    {
        ...
        $data['sidebar'] = "sidebar_gerente_ven";
...
/////////////////////////////////////////////////////////////////////////////////////////
     public function tabla_desplaza()
    {
		...
		$data['tabla'] = '';
        $data['contenido'] = "ger_form_pedidos_ger_for";
        $data['selector'] = "nacional";
        $data['sidebar'] = "sidebar_gerente_ped";
        $this->load->view('header');
        $this->load->view('main', $data);
        $this->load->view('extrafooter');
...
/////////////////////////////////////////////////////////////////////////////////////////
     public function tabla_desplaza_t()
    {
        ...
        $gerente = $this->catalogo_model->busca_gerente_reg($this->session->userdata('plaza'));
        $data['mensaje']= '';
...
/////////////////////////////////////////////////////////////////////////////////////////
     ...
     public function tabla_desplaza_nid()
    {
        ...
        $this->load->model('nacional_model');
		$data['tabla'] = '';
        $data['contenido'] = "ger_form_pedidos_ger_for_nid";
        $data['selector'] = "nacional";
        $data['sidebar'] = "sidebar_gerente_ped";
        $this->load->view('header');
        $this->load->view('main', $data);
...
/////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////
     public function pedidos_ger()
    {
        $data['mensaje']= '';
        $data['titulo']= 'PEDIDOS SOLICITADOS AL ALMACEN CENTRAL';
        $data['titulo1']= '';
        $this->load->model('catalogo_model');
		$data['mesx'] = $this->catalogo_model->busca_mes();
        $data['aaax'] = $this->catalogo_model->busca_anio();
        $data['tabla']= 'BUENOS DIAS A TODO EL PERSONAL';
        $data['contenido'] = "gerente_form_pedidos_ger";
        $data['selector'] = "gerente";
        $data['sidebar'] = "sidebar_gerente_ped";
   ...
   public function tabla_control_pedidos_ger()
    {
        ...
        $data['tabla'] = $this->gerente_model->control_pedidos_ger($fec);
        
        $data['titulo'] = "PEDIDOS DEL MES DE $mesx DEL $aaa";
        $data['titulo1'] = "";
        $data['contenido'] = "gerente";
        $data['selector'] = "gerente";
        $data['sidebar'] = "sidebar_gerente_ped";
...
/////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////
   public function tabla_control_pedidos_ger_det($fec,$superv)
    {
        $aaa= substr($fec,0,4);
		$mes= substr($fec,5,2);
        $this->load->model('catalogo_model');
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_pedidos_ger_sup($fec,$superv);
   ...
   public function pedido_folio($suc,$fec)
    {
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_pedido_folio($fec,$suc);
   ...
   public function pedido_detalle($suc,$fec,$fol)
    {
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_pedido_detalle($fec,$suc,$fol);
...
/////////////////////////////////////////////////////////////////////////////////////////
    public function ventas()
    {
        ...
        $data['aaax'] = $this->catalogo_model->busca_anio();
        $data['tabla']= 'BUENOS DIAS A TODO EL PERSONAL';
        $data['contenido'] = "gerente_form_ventas";
        $data['selector'] = "gerente";
        $data['sidebar'] = "sidebar_gerente_ven";
...
/////////////////////////////////////////////////////////////////////////////////////////////
    public function ventas_sup()
    {
        ...
        $data['titulo1']= '';
        $this->load->model('gerente_model');
		$data['tabla']= $this->gerente_model->control_ventas_sup($fec);
        $data['contenido'] = "gerente";
        $data['selector'] = "gerente";
        $data['sidebar'] = "sidebar_gerente_ven";
   ...
   public function tabla_control_ventas($superv,$fec)
    {
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_ventas($superv,$fec);
   ...
   public function venta_dia($suc,$fec)
    {
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_ventas_dia($fec,$suc);
  ...
  public function cortes()
    {
        ...
        $data['aaax'] = $this->catalogo_model->busca_anio();
        $data['tabla']= 'BUENOS DIAS A TODO EL PERSONAL';
        $data['contenido'] = "gerente_form_cortes";
        $data['selector'] = "gerente";
        $data['sidebar'] = "sidebar_gerente_ven";
...
/////////////////////////////////////////////////////////////////////////////////////////////
   public function tabla_control_cortes_sup()
    {
        $aaa= $this->input->post('aaa');
        $mes= $this->input->post('mes');
        $fec=$aaa."-".str_pad($mes,2,0,STR_PAD_LEFT);
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_cortes_sup($fec);
   ...
   public function tabla_control_cortes($superv,$fec)
    {
        ...
        $this->load->model('gerente_model');
        $data['tabla'] = $this->gerente_model->control_cortes($superv,$fec);
        $data['titulo'] = "CORTES DE CAJA DEL MES DE $mesx DEL $aaa";
        $data['titulo1'] = "";
        $data['contenido'] = "gerente";
        $data['selector'] = "gerente";
   ...
   public function corte_dia($suc,$fec)
    {
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_corte_dia($fec,$suc);
  ...
  public function cortes_comanche()
    {
        ...
        $data['aaax'] = $this->catalogo_model->busca_anio();
        $data['tabla']= 'BUENOS DIAS A TODO EL PERSONAL';
        $data['contenido'] = "gerente_form_recarga";
        $data['selector'] = "gerente";
        $data['sidebar'] = "sidebar_gerente_ven";
...
/////////////////////////////////////////////////////////////////////////////////////////
  ...
  public function cortes_comanche_sup()
    {
        $aaa= $this->input->post('aaa');
        $mes= $this->input->post('mes');
        $fec=$aaa."-".str_pad($mes,2,0,STR_PAD_LEFT);
        ...
        $data['titulo1']= '';
        $this->load->model('gerente_model');
        $data['tabla'] = $this->gerente_model->control_cortes_recarga_sup($fec);
        $data['contenido'] = "gerente";
        $data['selector'] = "gerente";
        $data['sidebar'] = "sidebar_gerente_ven";
  ...
  public function tabla_control_recarga($superv,$fec)
    {
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_cortes_recarga($superv,$fec);
...
/////////////////////////////////////////////////////////////////////////////////////////
    public function tarjetas()
    {
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_tar();
...
/////////////////////////////////////////////////////////////////////////////////////////////
    public function tarjetas_sup($superv)
    {
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_tar_sup($superv);
   ...
   public function tabla_control_tarjetas_fol($suc)
    {
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_tar_folio($suc);
   ...
   public function tabla_control_tarjetas_fol_pro($suc,$tar)
    {
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_tar_folio_pro($suc,$tar);
   ...
   public function tabla_control_tarjetas_pro($suc)
    {
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_tar_pro($suc);
   ...
   public function tabla_control_tarjetas_pro_det($suc,$cod)
    {
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_tar_pro_det($suc,$cod);
   ...
   public function tabla_control_tarjetas_fol_otras($suc)
    {
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_tar_folio_otras($suc);
   ...
   public function tabla_control_tarjetas_fol_pro_otras($suc,$tar)
    {
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_tar_folio_pro_otras($suc,$tar);
   ...
   public function tabla_control_tarjetas_pro_otras($suc)
    {
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_tar_pro_otras($suc);
   ...
   public function tabla_control_tarjetas_pro_det_otras($suc,$cod)
    {
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_tar_pro_det_otras($suc,$cod);
   ...
   public function natur()
    {
        ...
        $data['aaax'] = $this->catalogo_model->busca_anio();
        $data['tabla']= 'BUENOS DIAS A TODO EL PERSONAL';
        $data['contenido'] = "gerente_form_ventas_nat";
        $data['selector'] = "gerente";
        $data['sidebar'] = "sidebar_gerente_ven";
   ...
   public function tabla_control_ventas_nat()
    {
        ...
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_ventas_nat($aaa);
   ...
   public function tabla_control_ventas_nat_sup($superv,$aaa)
    {
        $this->load->model('gerente_model');
        $data['fechac']= date('Y-m-d');
        $data['tabla'] = $this->gerente_model->control_ventas_nat_sup($superv,$aaa);
   ...
   public function tabla_comision()
    {
        ...
        $data['titulo1'] = "";
        $data['tabla'] = $this->gerente_model->comision();
        $data['contenido'] = "gerente";
        $data['selector'] = "gerente";
        $data['sidebar'] = "sidebar_gerente_ven";
...
/////////////////////////////////////////////////////////////////////////////////////////
   public function tabla_comision_sup($fecha)
    {
       ...
       $mes=substr($fecha,5,2);
        ...
        $data['titulo1']= '';
        $this->load->model('gerente_model');
        $data['tabla']= $this->gerente_model->comision_sup($fecha);
        $data['contenido'] = "gerente";
        $data['selector'] = "gerente";
        $data['sidebar'] = "sidebar_gerente_ven";
   ...
   public function comision_det($superv,$fecha)
    {
        ...
        $this->load->model('gerente_model');
        $data['tabla']= $this->gerente_model->comision_det($superv,$fecha);
        $data['contenido'] = "gerente";
        $data['selector'] = "gerente";
        $data['sidebar'] = "sidebar_gerente_ven";
   ...
   public function indexm()
    {
        ...
        $data['contenido'] = "gerente";
        $data['selector'] = "gerente";
        $data['sidebar'] = "sidebar_gerente_mov";
   ...
   public function movimiento()
    {
        ...
        $this->load->model('catalogo_model');
        $this->load->model('gerente_model');
        $data['nomx'] = $this->catalogo_model->empleado_ger();
		$data['motx'] = $this->catalogo_model->busca_mov_super_ger_cambio();
        $data['sucx'] = $this->catalogo_model->busca_sucursal_gerente_suc($plaza);
        $data['tabla']= $this->gerente_model->captura_de_mov();
        $data['contenido'] = "gerente_form_reporta";
        $data['selector'] = "gerente";
        $data['sidebar'] = "sidebar_gerente_mov";
...
function movimiento_reporta()
    ...
    $this->load->model('gerente_model');
    $this->gerente_model->agrega_member_movimiento($id_emp,$id_mov,$fecha_i,$obser,$suc);
    redirect('gerente/movimiento');
...
public function tabla_empleados_validar($id)
    {
     ...
     $this->load->model('gerente_model');
     $this->gerente_model->valida_member_empleados($id,$fechaf);
     redirect('gerente/movimiento');
    }
 ...
 public function tabla_empleados_borrar($id)
    {
     ...
     $this->load->model('gerente_model');
     $this->gerente_model->delete_member_empleados($id);
     redirect('gerente/movimiento');
    }
//////////////////////////////////////////////////////////////
  public function movimiento_his_motivo()
    {
        $plaza= $this->session->userdata('plaza');
        $data['mensaje']= '';
        $this->load->model('catalogo_model');
        $data['motivox'] = $this->catalogo_model->busca_mov_super_ger();
        $data['supervx'] = $this->catalogo_model->busca_sucursal_gerente_s($plaza);
        $data['titulo']= 'EMPLEADOS REPORTADOS COMO ALTA';
        $data['titulo1']= '';
        $data['tabla']= '';
        $data['contenido'] = "gerente_form_motivo";
        $data['selector'] = "gerente";
        $data['sidebar'] = "sidebar_gerente_mov";
   ...
   public function movimiento_his()
    {
        ...
        $superv= $this->input->post('superv');
        $data['mensaje']= '';
        $data['titulo']= 'HISTORICO DE MOVIMIENTOS';
        $data['titulo1']= '';
        $this->load->model('catalogo_model');
        $this->load->model('gerente_model');
        $data['tabla']= $this->gerente_model->captura_de_mov_his($motivo,$superv);
        $data['contenido'] = "gerente";
        $data['selector'] = "gerente";
        $data['sidebar'] = "sidebar_gerente_mov";
...
/////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////
  public function movimiento_his_al()
    {
        $plaza= $this->session->userdata('plaza');
        $data['mensaje']= '';
        $this->load->model('catalogo_model');
        $data['motivox'] = $this->catalogo_model->busca_alta_baja_ger();
        $data['supervx'] = $this->catalogo_model->busca_sucursal_gerente_s($plaza);
        $data['titulo']= 'EMPLEADOS REPORTADOS COMO ALTA';
        $data['titulo1']= '';
        $data['tabla']= '';
        $data['contenido'] = "gerente_form_alta";
        $data['selector'] = "gerente";
        $data['sidebar'] = "sidebar_gerente_mov";
...
///////////////////////////
   public function movimiento_his_a()
    {
        $plaza= $this->session->userdata('plaza');
        $motivo= $this->input->post('motivo');
        $superv= $this->input->post('superv');
        ...
        $this->load->model('catalogo_model');
        $this->load->model('gerente_model');
        $data['tabla']= $this->gerente_model->alta_baja_emp($motivo,$superv);
        $data['contenido'] = "gerente";
        $data['selector'] = "gerente";
        $data['sidebar'] = "sidebar_gerente_mov";
