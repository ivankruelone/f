...
<div align="center">
  <?php
	$atributos = array('id' => 'rh_form_documento_entregado');
    echo form_open('recursos_humanos/entrega_recibo_his', $atributos);
$data_fec1 = array(
              'name'        => 'fec1',
              'id'          => 'fec1',
              'value'       => '',
...
<tr>
	...
	<td align="left"><?php echo form_dropdown('clave', $clax, '', 'id="clave"') ;?> </td>
...
/////////////////////////////////////////////////
    ...
    $('#rh_form_documento_entregado').submit(function() {
