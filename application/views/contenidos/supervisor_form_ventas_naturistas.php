...
<div align="center">
  <?php
	$atributos = array('id' => 'supervisor_form_ventas_naturistas');
    echo form_open('supervisor/tabla_control_ventas_naturistas', $atributos);
  ?>
...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
    $('#supervisor_form_ventas').submit(function() {
