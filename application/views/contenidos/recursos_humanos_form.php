...
<div align="center">
  <?php
	$atributos = array('id' => 'recursos_humanos_form');
    echo form_open('recursos_humanos/tabla_mov_supervisor_motivo', $atributos);
...
<tr>
	<th align="center" ><font size="+1">MOVIMIENTOS CAPTURADOS POR EL SUPERVISOR</font></th>
</tr>
<tr>
...
/////////////////////////////////////////////////
    ...
    $('#recursos_humanos_form').submit(function() {
