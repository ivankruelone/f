...
?>
      <div id="menubar">
        <ul id="menu">
          ...
          <li<?php if(isset($selector) && $selector == "contacto") echo " class=\"selected\"";?>><?php echo anchor('contacto/index', 'Contacto');?></li>
          <li<?php if(isset($selector) && $selector == "archivos") echo " class=\"selected\"";?>><?php echo anchor('contacto/archivos', 'Archivos recibidos');?></li>
...
<li<?php if(isset($selector) && $selector == "subida") echo " class=\"selected\"";?>><?php echo anchor('compras/index_ped', 'PEDIDOS FORMULADOS');?></li>          
...
?>
    <div id="menubar">
        <ul id="menu">
        <li<?php if(isset($selector) && $selector == "a_inv") echo " class=\"selected\"";?>><?php echo anchor('a_inv/index', 'Inventario');?></li>
        <li<?php if(isset($selector) && $selector == "mueble") echo " class=\"selected\"";?>><?php echo anchor('a_surtido/tabla_control_mue', 'HUBICACION');?></li>  
        <li<?php if(isset($selector) && $selector == "pedidos") echo " class=\"selected\"";?>><?php echo anchor('pedido/pedido', 'PEDIDOS');?></li>
        <li<?php if(isset($selector) && $selector == "a_surtido") echo " class=\"selected\"";?>><?php echo anchor('a_surtido/tabla_control_his_busqueda', 'FOLIOS CERRADOS');?></li>
...
?>
    ...
    <div id="menubar">
        <ul id="menu">
          <li<?php if(isset($selector) && $selector == "mercadotecniac") echo " class=\"selected\"";?>><?php echo anchor('mercadotecnia/index_tar', 'TARGETAS DE CLIENTE');?></li>
          ...
          <li<?php if(isset($selector) && $selector == "mercadotecniav") echo " class=\"selected\"";?>><?php echo anchor('mercadotecnia/indexv', 'VENTAS');?></li>
        </ul>
      </div>
...
?>
    ...
    <div id="menubar">
        <ul id="menu">
          ...
          <li<?php if(isset($selector) && $selector == "ped") echo " class=\"selected\"";?>><?php echo anchor('compras/index_ped', 'PEDIDOS FORMULADOS');?></li>
          <li<?php if(isset($selector) && $selector == "orden") echo " class=\"selected\"";?>><?php echo anchor('compras/index_ord', 'ORDEN DE COMPRA');?></li>
          
          <li<?php if(isset($selector) && $selector == "subida") echo " class=\"selected\"";?>><?php echo anchor('compras/index_inv', 'INV');?></li>
          <li<?php if(isset($selector) && $selector == "subida1") echo " class=\"selected\"";?>><?php echo anchor('compras/index_des', 'DESPLAZAMIENTO');?></li>
          <li<?php if(isset($selector) && $selector == "compra") echo " class=\"selected\"";?>><?php echo anchor('compras/index_com', 'COMPRA');?></li>
          <li<?php if(isset($selector) && $selector == "faltante") echo " class=\"selected\"";?>><?php echo anchor('compras/index_fal', 'FANTANTES');?></li>
        </ul>
      </div>
...
?>
    ...
    <div id="menubar">
        <ul id="menu">
        <li<?php if(isset($selector) && $selector == "contacto") echo " class=\"selected\"";?>><?php echo anchor('cat_generico/index', 'Catalogo Metro y Generico');?></li>
        </ul>
      </div>      
