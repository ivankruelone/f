...
<div align="center">
  <?php
	$atributos = array('id' => 'catalogo_form_usuario_cortes');
    echo form_open('catalogo/agrega_c_usuario_sucursal_cortes', $atributos);
  ?>
...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
    $('#catalogo_form_usuario_cortes').submit(function() {
