...
<div align="center">
  <?php
	$atributos = array('id' => 'catalogo_form_usuario_bus_rh');
...
/////////////////////////////////////////////////
     ...
     $('#mat').blur(function(){
      ...
      if(nom > ' ' ){
            $.post("<?php echo site_url();?>/recursos_humanos/busca_empleado_nombre_rh/", { nom: nom, pat: pat, mat: mat}, function(data){
            $("#tabla").html(data);
...
var correo = $('#correo').attr("value");
    $('#catalogo_form_usuario_bus_rh').submit(function() {
