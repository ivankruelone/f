...
<div align="center">
  <?php
	$atributos = array('id' => 'recursos_humanos_form_empleados_al');
    echo form_open('recursos_humanos/agrega_empleados', $atributos);
...
/////////////////////////////////////////////////
    ...
    $('#recursos_humanos_form_empleados_al').submit(function() {
         ...
         var suc = parseFloat($("#suc").attr('value'));
         var cia = parseFloat($("#cia").attr('value'));
         var puesto = parseFloat($("#puesto").attr('value'));
      
      
        if(cia>0  && suc>0 && puesto>0 && afilia>10 && registro_pat>6 && nom>0 && pat>0 && mat>0){
