...
<div align="center">
  <?php
	$atributos = array('id' => 'a_devolucion_form_suc');
    echo form_open('a_devolucion/agrega_ctl', $atributos);
     $data_rrm = array(
              'name'        => 'rrm',
              'id'          => 'rrm',
              'value'       => '',
...
<tr>
	<td align="left" ><font size="+1">MOVIMIENTO: </font></td>
	<td><?php echo form_dropdown('mov', $movx, '', 'id="mov"') ;?> </td>
</tr>
<tr>
...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
    $('#a_devolucion_form_suc').submit(function() {
