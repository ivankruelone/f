...
<div align="center">
  <?php
	$atributos = array('id' => 'nacional_form_pedidos_ger_for_nid_t');
    echo form_open('nacional/tabla_desplaza_t_nid_t', $atributos);
  ?>
...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
    $('#nacional_form_pedidos_ger_for_nid_t').submit(function() {
