...
<div align="center">
  <?php
	$atributos = array('id' => 'recursos_humanos_form_empleados_ab_his');
    echo form_open('recursos_humanos/tabla_empleados_captura_ab_his_imp', $atributos);
$data_fec1 = array(
              'name'        => 'fec1',
              'id'          => 'fec1',
              'value'       => '',
...
/////////////////////////////////////////////////
    ...
    $('#recursos_humanos_form_empleados_ab_his').submit(function() {
