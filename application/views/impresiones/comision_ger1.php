...
$num=1;
$s0 = "select a.*, sum(ger_vta)as premio_vta  from vtadc.comision a
where
fecha='$fecha' and puestox='GER' and ger_vta>0
group by  nomina";
$q0 = $this->db->query($s0);
...
//----------------------------------------------------------------------------------------------------------------
 ...
 where a.nomina=$r0->nomina  and fecha='$fecha' and ger_vta>0";
        $q2 = $this->db->query($s2);
...
$detalle.="
         ...
         <tr>
            ...
            <td align=\"right\" colspan=\"1\"><strong> $ ".number_format($r2->ger_vta,2)."</strong></td>
        </tr> ";  
$num=$num+1;
