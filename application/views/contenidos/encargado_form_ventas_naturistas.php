...
<div align="center">
  <?php
	$atributos = array('id' => 'encargado_form_ventas_naturistas');
    echo form_open('encargado/tabla_control_ventas', $atributos);
  ?>
...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
    $('#encargado_form_ventas_naturistas').submit(function() {
