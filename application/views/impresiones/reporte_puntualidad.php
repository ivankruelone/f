...
$reporte = $this->checador_model->get_reporte_juntificacion2_moronatti($quincena, $row->succ);
...
$reporte = $this->checador_model->get_reporte_juntificacion1_moronatti($quincena, $row->succ);
