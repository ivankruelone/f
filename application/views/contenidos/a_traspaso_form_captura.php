...
////////////////////////////////////////////////////////////////////////////////////// 
	...
	$atributos = array('id' => 'a_traspaso_form_captura');
 ...
 <?php
  ...
  <script language="javascript" type="text/javascript">
    ...
    $('#sec').blur(function(){
      ...
      if(sec > 0){
            $.post("<?php echo site_url();?>/a_inv/busca_lote/", { sec: sec}, function(data){
                if(data == '0'){
                    alert('La sec ' + sec + ' no tiene existencia.');
                    $('#sec').val('').focus();
                    $('#lote').val('');
                }else{
...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
    $('#a_traspaso_form_captura').submit(function() {
