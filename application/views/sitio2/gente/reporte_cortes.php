            <div class="row">
                <div class="span12">
                <h3>Reporte de corte del <?php echo $inicio;?> hasta <?php echo $inicio;?></h3>
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><?php echo anchor('gente/reporte_cortes_sucursal_detalle/'.$row->suc.'/'.$inicio.'/'.$fin, 'Detalle')?></td>
                        </tr>
                        <?php
