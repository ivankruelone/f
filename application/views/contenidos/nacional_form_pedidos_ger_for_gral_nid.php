...
<div align="center">
  <?php
	$atributos = array('id' => 'nacional_form_pedidos_ger_for_gral_nid');
    echo form_open('nacional/tabla_desplaza_t_gral_nid', $atributos);
  ?>
...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
    $('#nacional_form_pedidos_ger_for_gral_nid').submit(function() {
