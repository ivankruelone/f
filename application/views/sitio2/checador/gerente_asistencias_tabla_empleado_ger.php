                        ...
                        <tr>
                            ...
                            if($row->falta == 1 || $row->retardo == 1 ){
                                ...
                                if($row->justificada == 0 ){
                                    echo anchor('checador/gerente_justificar_ger/'.$row->id_registro, 'Just.', array('id' => 'justifica_'.$row->id)); 
                                }else{
                                    echo anchor('checador/gerente_justificar_quita_ger/'.$row->id_registro, 'No Just.', array('id' => 'quita_'.$row->id)); 
                                }
