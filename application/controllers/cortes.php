  ...
  public function indexp()
    {
        ...
        $data['selector'] = "plantilla";
        $data['sidebar'] = "sidebar_plantilla_cortes";
 ...
 public function tabla_plantilla()
    {
        ...
        $data['tabla'] = $this->cortes_model->control_plantilla();
        $data['contenido'] = "cortes";
        $data['selector'] = "plantilla";
        $data['sidebar'] = "sidebar_plantilla_cortes";
...
public function cambia_fal_nom($id)
    {
        ...
        $row=$query->row();
        $nomina=$row->nomina;
		$data['tabla'] = $this->cortes_model->control_fal_t($id,$clave);        
...
public function agrega_credito()
    {
        ...
        $clave=519;
        $this->load->model('cortes_model');
		$this->cortes_model->add_member_credito($id_cre,$id_emp,$importe,$clave,$obser);
...
public function agrega_credito_cor()
    {
        ...
        $obser= $this->input->post('obser');
        $this->load->model('cortes_model');
		$this->cortes_model->add_member_credito_cortes($id_cre,$id_emp,$importe,$obser);
...

   public function tabla_control_faltante2_par($plaza1,$fec1,$fec2)
    {
        $this->load->model('cortes_model');
        $data['tabla'] = $this->cortes_model->control_faltante1($plaza1, $fec1, $fec2);
        $data['titulo'] = "POLIZA DE CORTES";
...
///////////////////////////////////////////////////////////  
///////////////////////////////////////////////////////////
public function varias_quincenas_cor($id)
    {
        $this->load->model('catalogo_model');
        $this->load->model('cortes_model');
		$query = $this->cortes_model->busca_faltante($id);
        ...
        $data['sucx'] = $row->sucx;
        $data['nom'] = $nomina;
        $data['fecpre'] = $this->catalogo_model->fecpre();
        
        $this->load->model('cortes_model');
        $data['tabla'] = $this->cortes_model->control_fal_t_con_var_qui($id,$clave,$turno);
        $data['titulo'] = "<font color=\"red\">FALTANTES NO APLCADOS DIVIDIDOS EN VARIAS QUINCENAS</font>";
        $data['contenido'] = "faltante_form_varias_quin_cor";
        $data['selector'] = "cortes";
        $data['sidebar'] = "sidebar_cortes";
...
///////////////////////////////////////////////////////////  
///////////////////////////////////////////////////////////
public function varias_quincenas($id)
    {
        $this->load->model('catalogo_model');
        $this->load->model('cortes_model');
		$query = $this->cortes_model->busca_faltante($id);
        ...
        $this->load->model('cortes_model');
        $data['titulo'] = "<font color=\"red\">FALTANTES NO APLCADOS DIVIDIDOS EN VARIAS QUINCENAS</font>";
        $data['contenido'] = "faltante_form_varias_quin";
        $data['selector'] = "cortes";
        $data['sidebar'] = "sidebar_cortes";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////  
public function agrega_faltante_dividido_cor()
    {
        $id_fal= $this->input->post('id_fal');
        $id_emp= $this->input->post('id_emp');
        $importe= $this->input->post('importe');
        ...
        $clave= 520;
        $this->load->model('cortes_model');
        $this->cortes_model->agrega_member_fa_dividido($id_fal,$id_emp,$importe,$motivo,$clave,$fecpre);
        redirect('cortes/varias_quincenas_cor/'.$id_fal);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////  
public function agrega_faltante_dividido()
    {
        $id_fal= $this->input->post('id_fal');
        $id_emp= $this->input->post('id_emp');
        $importe= $this->input->post('importe');
        ...
        $this->load->model('cortes_model');
        $this->cortes_model->agrega_member_fa_dividido($id_fal,$id_emp,$importe,$motivo,$clave,$fecpre);
        redirect('cortes/varias_quincenas/'.$id_fal);
        
    }
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
public function borrar_fal_det_con_varias_quin($id,$id_falc)
    {
         $nivel=$this->session->userdata('nivel');
         $this->load->model('cortes_model');
		$this->cortes_model->delete_member_faltante_det($id);
if($nivel==5){redirect('cortes/varias_quincenas_cor/'.$id_falc);}else{redirect('cortes/varias_quincenas/'.$id_falc);}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
public function delete_fal_gercon($id_fal,$plaza1,$fec1,$fec2)
    {
        $motivo= $id_user= 'AUTORIZA '.$this->session->userdata('nombre'); 
        $this->load->model('cortes_model');
		$this->cortes_model->delete_member_fal_gercon($id_fal,$motivo);
redirect('cortes/tabla_control_faltante2_par/'.$plaza1.'/'.$fec1.'/'.$fec2);   
    }

...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 public function indexr()
    {
        ...
        $data['contenido'] = "cortes";
        $data['selector'] = "cortes";
        $data['sidebar'] = "sidebar_reportes_cortes";
 ...
 /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 public function tabla_control_reportes_faltantes()
    {
        $this->load->model('catalogo_model');
		$data['mesx'] = $this->catalogo_model->busca_mes();
        $data['aaax'] = $this->catalogo_model->busca_anio();
        ...
        $this->load->model('cortes_model');
        $data['titulo'] = "SUCURSALES ASIGNADAS";
        $data['contenido'] = "faltantes_cortes_form";
        $data['selector'] = "cortes";
        $data['sidebar'] = "sidebar_reportes_cortes";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 public function tabla_control_reportes_faltantes_det()
    {
$this->load->model('catalogo_model');
$quin=$this->input->post('quin');
...
if($quin==1){$dia=15;}
if($quin==2){
$dia=$this->catalogo_model->busca_mes_quincena($me);
}
$fec=$this->input->post('aaa').'-'.str_pad($me,2,0,STR_PAD_LEFT).'-'.str_pad($dia,2,0,STR_PAD_LEFT);
$clavex=$this->catalogo_model->busca_clave_una($this->input->post('clave'));

        $data['mensaje']= '';
        $data['titulo']= 'CAPTURA DE CORTES';
        $data['titulo1']= '';
        $this->load->model('cortes_model');
        $data['tabla'] = $this->cortes_model->c_reporte_faltantes_cortes($this->input->post('clave'),$fec,$clavex);
        $data['contenido'] = "cortes";
        $data['selector'] = "cortes";
        $data['sidebar'] = "sidebar_reportes_cortes";
