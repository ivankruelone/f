...
$num=1;
$s0 = "select a.*, sum(sup_vta)as premio_vta  from vtadc.comision a
where
fecha='$fecha' and puestox='SUP' and sup_vta>0
group by  nomina";
$q0 = $this->db->query($s0);
$detalle="<table border=\".1\">
           <tr>
           <td colspan=\"4\" align=\"center\"><strong>COMISION MENSUAL DE $mesx DEL $aaa POR VENTA</strong></td>
           </tr>
...
//----------------------------------------------------------------------------------------------------------------
 ...
 where a.nomina=$r0->nomina  and fecha='$fecha' and sup_vta>0";
        $q2 = $this->db->query($s2);
...
$detalle.="
         ...
         <tr>
            ...
            <td align=\"right\" colspan=\"1\"><strong> $ ".number_format($r2->sup_vta,2)."</strong></td>
        </tr> ";  
...
$detalle.=" 
        <tr bgcolor=\"#EDD8D8\">
           <td colspan=\"3\" align=\"left\">SUPERVISOR..:<strong>".$r0->nomina." - ".$r0->pat." ".$r0->mat." ".$r0->nom."</strong> <br /></td>
           <td colspan=\"1\" align=\"right\">IMPORTE..:<strong>".$r0->premio_vta."</strong></td>
           </tr>"; 
$total1=$total1+$r0->premio_vta;
}
$detalle.="
<tr bgcolor=\"#DAFACB\">
