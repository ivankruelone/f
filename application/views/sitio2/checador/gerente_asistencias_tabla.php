            <div class="row">
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        if($row->falta>0 || $row->retardo>2){$color='red';}else{$color='green';}
                        if($row->checa==0){$color='blue';$fal=0;}else{$fal=$row->falta;}
                        $accion=anchor('checador/gerente_detalle_empleado_periodo/'.$row->empleado_id.'/'.$inicio.'/'.$fin, 'Detalle');
                        ?>
                        <tr>
